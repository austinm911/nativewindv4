            ...
            <View className="py-12 md:py-24 lg:py-32 xl:py-48">
                <View className="px-4 bg-green-200 md:px-6">
                    <View className="flex flex-col gap-4 items-center text-center">
                        <Text
                            role="heading"
                            className="text-3xl font-bold tracking-tighter text-center text-red-500 bg-red-200 native:text-5xl sm:text-4xl md:text-5xl lg:text-6xl"
                        >
                            Welcome to Project ACMEs
                        </Text>
                        <Text className="mx-auto max-w-[700px] text-lg text-center text-gray-500 md:text-xl dark:text-gray-400">
                            Discover and collaborate on amce. Explore our
                            services now.
                        </Text>
